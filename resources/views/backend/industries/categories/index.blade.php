...
@section('title', config('constants.BUSINESS.name') . ' | Industry Categories')
                    ...
                    <tr>
                         ...
                         {{-- Status --}}
                                <td>
                                    <span
                                        ...
                                        data-url="{{ route('admin.marketing.industries.categories.togglestatus', $category->uuid) }}">
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <a href="{{ route('admin.marketing.industries.categories.createoredit', $category->uuid) }}"
                                   class="btn btn-sm btn-outline-primary d-flex align-items-center gap-1">
                                    <i class="bx bx-edit-alt"></i> Edit
                                </a>

                                <form action="{{ route('admin.marketing.industries.categories.destroy', $category->uuid) }}"
