...
@section('title', isset($category) ? 'Edit Technology Category' : 'Create Technology Category')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">{{ isset($category) ? 'Edit' : 'Create' }} Technology Category</h5>
    </div>
    ...
    <form method="POST"
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-6">
                ...
                @if(!empty($category->image))
                    <img src="{{ asset($category->image) }}" class="mt-2 rounded" height="80">
                @endif
            </div>
        ...
        <div class="card-footer text-end">
            <a href="{{ route('admin.tech-categories.index') }}" class="btn btn-secondary">Cancel</a>
