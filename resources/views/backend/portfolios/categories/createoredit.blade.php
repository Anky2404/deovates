...
@section('title', isset($category) ? 'Deovate | Edit Category' : 'Deovate | Create Category')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">{{ isset($category) ? 'Edit' : 'Create' }} Portfolio Category</h5>
    </div>

    <form method="POST"
          action="{{ route('admin.portfolios.categories.saveorupdate', $category->uuid ?? null) }}"
        ...
        <div class="card-footer text-end">
            <a href="{{ route('admin.portfolios.categories.index') }}" class="btn btn-secondary">Cancel</a>
