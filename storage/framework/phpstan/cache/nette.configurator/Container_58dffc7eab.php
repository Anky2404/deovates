...
class Container_58dffc7eab extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_58dffc7eab $container)
			{
	...
	public function createServiceContainer(): Container_58dffc7eab
	{
		return $this;
	}
